<template>
    <el-card>
        <div style="display:flex;">
            <img :src="userStore.avatar" style="width:120px; height:120px; border-radius:50%;">
            <div style="margin-left:20px;">
                <h3 style="font-size: 24px;font-weight:900;">{{ getTime() }}好{{ userStore.username }}</h3>
 ...
 -->
        ...
        <p>上传文件夹</p>
        <input ref="planFileRef" class="show0" type="file" webkitdirectory @change="selectFile" />
    </div>
</template>
